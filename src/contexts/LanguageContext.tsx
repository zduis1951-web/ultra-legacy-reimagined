...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Profile Brochure
    "profile.established": "Established 2015",
    "profile.tagline": "A Decade of Excellence in Real Estate",
    "profile.valuesTag": "Our Foundation",
    "profile.valuesTitle": "The Pillars of Our Success",
    "profile.values.integrity": "Integrity",
    "profile.values.integrityDesc": "We uphold the highest ethical standards, ensuring transparency and honesty in every transaction we undertake.",
    "profile.values.excellence": "Excellence",
    "profile.values.excellenceDesc": "We are committed to delivering top-notch service and achieving outstanding results that exceed expectations.",
    "profile.values.innovation": "Innovation",
    "profile.values.innovationDesc": "We embrace new technologies and creative approaches to stay ahead in the dynamic real estate market.",
    "profile.stats.experience": "Years of Excellence",
    "profile.stats.properties": "Properties Delivered",
    "profile.stats.clients": "Satisfied Clients",
    "profile.stats.projects": "Premium Projects",
    "profile.quote": "At Bayt Alshumukh, we believe that every property tells a story, and every client deserves a legacy. For over a decade, we have dedicated ourselves to transforming visions into reality, crafting not just transactions, but lasting relationships built on trust, expertise, and an unwavering commitment to excellence.",
    "profile.quoteAuthor": "The Management",
  },
  ar: {
    // Brand
    ...
    // Profile Brochure
    "profile.established": "تأسست عام 2015",
    "profile.tagline": "عقد من التميز في العقارات",
    "profile.valuesTag": "أساسنا",
    "profile.valuesTitle": "ركائز نجاحنا",
    "profile.values.integrity": "النزاهة",
    "profile.values.integrityDesc": "نلتزم بأعلى المعايير الأخلاقية، ونضمن الشفافية والصدق في كل معاملة نقوم بها.",
    "profile.values.excellence": "التميز",
    "profile.values.excellenceDesc": "نحن ملتزمون بتقديم خدمة من الدرجة الأولى وتحقيق نتائج متميزة تتجاوز التوقعات.",
    "profile.values.innovation": "الابتكار",
    "profile.values.innovationDesc": "نتبنى التقنيات الجديدة والأساليب الإبداعية للبقاء في المقدمة في سوق العقارات الديناميكي.",
    "profile.stats.experience": "سنوات من التميز",
    "profile.stats.properties": "عقار تم تسليمه",
    "profile.stats.clients": "عميل راضٍ",
    "profile.stats.projects": "مشروع متميز",
    "profile.quote": "في بيت الشموخ، نؤمن بأن كل عقار يروي قصة، وكل عميل يستحق إرثاً. على مدار أكثر من عقد، كرّسنا أنفسنا لتحويل الرؤى إلى واقع، لا نصنع معاملات فحسب، بل علاقات دائمة مبنية على الثقة والخبرة والالتزام الراسخ بالتميز.",
    "profile.quoteAuthor": "الإدارة",
  },
};
